    ...
    <div>
    	<table border="1" style="margin: auto;">
    		<tr>
    			...
    			<td>
    				<p><img src=<?php echo $row["rutaimagen"]; ?>></p>
    			</td>
    			<td>
    				<table>
    					...
    					<tr>
    						<td>
    							<form action="updateInfografia.php" method="post" >
    								<input class="input" type="text" name="Infografia" minlenght="5" maxlenght="500"  height="" required >
    								<button class="button" type="submit" name="Registrarse">Guardar</button>
    							</form>
    						</td> 
